        ...
        <aside
            ...
            <div class="flex-1 overflow-y-auto py-6 px-3 space-y-1">
                ...
                <a href="{{ route('master.sales') }}"
                    class="flex items-center px-4 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('master.sales') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fas fa-user-tie w-6 text-center mr-2"></i> Salesman
                </a>
