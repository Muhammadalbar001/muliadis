<aside
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1 custom-scrollbar">
        ...
        <a href="{{ route('master.produk') }}"
            class="flex items-center px-4 py-2.5 rounded-lg transition-colors group {{ request()->routeIs('master.produk') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            <i class="fas fa-box w-5 text-center"></i>
            <span class="ml-3 font-medium text-sm">Produk</span>
        </a>

        <a href="{{ route('master.supplier') }}"
            class="flex items-center px-4 py-2.5 rounded-lg transition-colors group {{ request()->routeIs('master.supplier') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('laporan.rekap-penjualan') }}"
            class="flex items-center px-4 py-2.5 rounded-lg transition-colors group {{ request()->routeIs('laporan.rekap-penjualan') ? 'bg-indigo-900/50 text-indigo-300 border-l-2 border-indigo-500' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('laporan.rekap-retur') }}"
            class="flex items-center px-4 py-2.5 rounded-lg transition-colors group {{ request()->routeIs('laporan.rekap-retur') ? 'bg-indigo-900/50 text-indigo-300 border-l-2 border-indigo-500' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('laporan.rekap-ar') }}"
            class="flex items-center px-4 py-2.5 rounded-lg transition-colors group {{ request()->routeIs('laporan.rekap-ar') ? 'bg-indigo-900/50 text-indigo-300 border-l-2 border-indigo-500' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            <i class="fas fa-file-invoice w-5 text-center"></i>
            <span class="ml-3 font-medium text-sm">Rekap Piutang (AR)</span>
        </a>
        <a href="{{ route('laporan.rekap-collection') }}"
            class="flex items-center px-4 py-2.5 rounded-lg transition-colors group {{ request()->routeIs('laporan.rekap-collection') ? 'bg-indigo-900/50 text-indigo-300 border-l-2 border-indigo-500' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('laporan.kinerja-sales') }}"
            class="flex items-center px-4 py-2.5 rounded-lg transition-colors group {{ request()->routeIs('laporan.kinerja-sales') ? 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-md' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            <i
