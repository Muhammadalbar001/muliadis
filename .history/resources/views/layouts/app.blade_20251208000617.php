...
<body class="font-sans antialiased bg-slate-50 text-slate-800">
    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: true }">
        ...
        <aside
            ...
            <div
                class="h-16 flex items-center justify-center border-b border-slate-800 bg-slate-950/50 backdrop-blur-sm">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                    <div
                        class="w-8 h-8 rounded-lg bg-indigo-500 flex items-center justify-center text-white font-bold text-lg">
                        M</div>
        ...
        <div class="flex-1 flex flex-col transition-all duration-300 ease-in-out"
            ...
            <header
                class="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40 px-6 flex items-center justify-between">
