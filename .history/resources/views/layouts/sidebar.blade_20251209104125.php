<aside
    ...
    <div class="h-20 flex-none flex items-center px-6 border-b border-slate-800/50 bg-slate-900/50 backdrop-blur-xl">
    ...
    <div class="flex-1 overflow-y-auto py-6 px-3 space-y-1 custom-scrollbar">
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group text-sm font-medium mb-4
        ...
        <p class="px-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 mt-6">Transaksi Harian</p>
        ...
        <a href="{{ route('transaksi.retur') }}" class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 group text-sm font-medium
           {{ request()->routeIs('transaksi.retur') 
            ...
            <span class="ml-3">Retur Barang</span>
        </a>
        ...
        <p class="px-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 mt-6">Laporan & Analisa</p>
    ...
    <div class="p-4 border-t border-slate-800 bg-slate-900 flex-none">
