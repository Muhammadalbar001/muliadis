<aside class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white transition-transform duration-300 transform"
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <div class="mt-6 mb-2 px-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
            Master Data
        </div>
        ...
        <a href="{{ route('laporan.kinerja-sales') }}"
            ...
            <i
                class="fas fa-chart-line w-5 text-center {{ request()->routeIs('laporan.kinerja-sales') ? 'text-white' : 'text-emerald-500 group-hover:text-white' }}"></i>
        ...
        <a href="{{ route('laporan.rekap-penjualan') }}"
            ...
            <span class="ml-3 font-medium text-sm">Rekap Full Excel</span>
        </a>
