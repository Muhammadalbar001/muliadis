...
<body class="font-jakarta antialiased bg-slate-50 text-slate-600" x-data="{ sidebarOpen: false }">
    ...
    <div x-data="{ 
         ...
         " class="fixed top-5 right-5 z-[100] flex flex-col gap-2" style="display: none;" x-show="show"
        ...
        <div :class="{
            ...
            class="flex items-center w-full max-w-xs p-4 text-gray-500 rounded-lg shadow-xl border border-slate-100"
            role="alert">
