        ...
        <div
            ...
            <div class="bg-slate-50 px-6 py-4 flex flex-row-reverse gap-3 border-t border-slate-200">
                <button wire:click="import" wire:loading.attr="disabled"
                    class="w-full sm:w-auto bg-{{ $color }}-600 text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-{{ $color }}-700 transition shadow-lg shadow-{{ $color }}-500/30 disabled:opacity-50 disabled:cursor-not-allowed">
                    Import Sekarang
                </button>
