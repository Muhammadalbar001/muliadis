        ...
        <div class="overflow-auto flex-1 w-full custom-scrollbar">
            <table class="text-xs text-left border-collapse whitespace-nowrap min-w-max">
                ...
                <thead class="text-gray-600 uppercase bg-gray-100 font-bold sticky top-0 z-20 shadow-sm">
                    <tr>
                        <th class="px-4 py-3 border-b border-r bg-gray-100 min-w-[250px]">Nama Produk</th>
                        ...
                        <th class="px-4 py-3 text-center border-b border-l bg-gray-100 w-24">Aksi</th>
                    </tr>
                </thead>
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    ...
                    <tr class="hover:bg-indigo-50 transition-colors {{ $item->is_duplicate ? 'bg-red-50' : '' }}">
                        ...
                        <td class="px-4 py-2 font-bold text-gray-800 border-r shadow-sm truncate max-w-[250px]"
                        ...
                        <td class="px-4 py-2 text-center border-l bg-white">
