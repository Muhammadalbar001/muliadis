<div class="space-y-4" x-data="{ activeGroup: 'general' }">
    ...
    <!-- REVISI PENTING: Container Utama harus memiliki overflow-auto atau overflow-x-auto -->
    <div class="bg-white border border-gray-300 shadow-sm rounded-lg overflow-x-auto h-[70vh]">
        <div class="w-full h-full">
            <!-- Konten dalam container vertikal -->
            <table class="min-w-max w-full text-xs text-left border-collapse">
                <!-- HEADER (Sticky Top) -->
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 sticky top-0 z-20">
                    <tr>
                        ...
                        <!-- Sticky Left perlu dikombinasikan dengan padding/border yang benar -->
