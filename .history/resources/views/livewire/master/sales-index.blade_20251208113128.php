    ...
    <div
        ...
        <div class="flex gap-2">
            <button wire:click="resetAllTargets"
                onclick="return confirm('Apakah Anda yakin ingin mereset SEMUA target sales (IMS & OA) menjadi 0?') || event.stopImmediatePropagation()"
                ...
                title="Hapus semua target IMS & OA di tabel master">
                    ...
                    <tr class="hover:bg-indigo-50 transition-colors">
                        ...
                        <td class="px-6 py-3 border-r text-center">
                            <button wire:click="openTargetModal({{ $item->id }})"
                                ...
                                <i class="fas fa-bullseye mr-1.5 group-hover:scale-110 transition-transform"></i> Target
                            </button>
                        </td>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 mb-4">Upload file Excel (.xlsx) berisi data salesman
                                    baru.</p>
                                ...
                                <div class="mt-4 flex items-center p-3 bg-red-50 rounded-lg border border-red-100">
                                    ...
                                    <label for="resetData" class="ml-2 block text-xs text-red-800 cursor-pointer">
                                        <span class="font-bold">Hapus Data Lama?</span> (Reset Table)<br>
                                        <span class="font-normal text-red-600">Centang jika ingin mengganti total semua
                                            data sales.</span>
                                    </label>
                                </div>
                                ...
                                @error('file')
                                <div class="mt-2 p-2 bg-red-100 border border-red-200 text-red-700 text-xs rounded">
