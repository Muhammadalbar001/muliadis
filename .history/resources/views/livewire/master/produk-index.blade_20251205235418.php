<div class="space-y-6">
    ...
    <tr class="hover:bg-gray-50 transition-colors group">
        ...
        <td class="px-6 py-4 font-medium text-indigo-600">
            {{ $item->sku }} </td>
        <td class="px-6 py-4">
            <div class="font-medium text-gray-800">{{ $item->name_item }}</div> <div class="text-xs text-gray-400 mt-0.5">{{ $item->kategori ?? '-' }}</div>
        </td>
...
Dengan perubahan ini, error `Unknown column 'nama_item'` akan hilang dan data akan tampil dengan benar.
            </table>
        </div>
