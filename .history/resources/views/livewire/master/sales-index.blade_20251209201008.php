<div class="space-y-6 font-jakarta">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Master Salesman</h1>
            <p class="text-sm text-slate-500 mt-1">Kelola data tim penjualan, divisi, dan target bulanan.</p>
        </div>
