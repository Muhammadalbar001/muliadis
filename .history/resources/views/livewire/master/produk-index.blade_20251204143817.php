<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-4 rounded-lg shadow">
        ...
        <div class="w-full md:w-auto">
            <div class="flex flex-col gap-1" x-data="{ isUploading: false, progress: 0 }"
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-center">
                        <span
                            class="px-2 py-1 {{ $item->stok > 10 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} rounded-full text-xs font-bold">
