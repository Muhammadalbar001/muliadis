<div class="space-y-4">
    ...
    <div class="bg-white border border-gray-300 shadow-sm rounded-lg flex flex-col">
        ...
        <!-- Tinggi dibatasi agar scroll vertikal hanya terjadi di area tabel, bukan seluruh halaman -->
        <div class="flex-1 overflow-x-auto overflow-y-auto" style="max-height: 85vh;">
