<div class="space-y-4">
    ...
    <div class="bg-white border border-gray-300 shadow-sm rounded-lg flex flex-col">
        ...
        <!-- Gunakan min-w-full pada div agar tabel didalamnya dipaksa selebar mungkin, memaksa scroll di div ini -->
            ...
            <table class="min-w-max text-xs text-left border-collapse table-auto">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-150">
                        <!-- === Kolom Fixed Kiri === -->
                        <!-- Tambahkan background putih pada TD sticky agar menimpa kolom di bawahnya saat scroll -->
                        <td
