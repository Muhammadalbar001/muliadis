<div class="space-y-6 font-jakarta">
    ...
    <div class="space-y-6 font-jakarta">
        ...
        <div
            class="sticky top-0 z-40 backdrop-blur-md bg-white/90 p-4 rounded-b-2xl shadow-sm border-b border-slate-200 transition-all duration-300 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 class="text-xl font-extrabold text-slate-900 tracking-tight">Data Salesman</h2>
        ...
        <div class="px-5 py-2.5 bg-white rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
            <div class="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600">
                <i class="fas fa-users text-lg"></i>
            </div>
            <div>
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Total Sales</p>
                <p class="text-xl font-bold text-slate-800 leading-none">{{ $sales->total() }} <span
                        class="text-xs font-medium text-slate-400">Orang</span></p>
            </div>
        </div>
    </div>

    <div
        class="bg-white p-5 rounded-2xl shadow-sm border border-indigo-50 flex flex-col md:flex-row justify-between items-end gap-4">
        ...
        <div class="w-full md:w-3/4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="relative group">
                ...
                <div
                    class="absolute left-3.5 top-3 text-slate-400 group-focus-within:text-indigo-500 transition-colors">
                    ...
                    <div class="bg-rose-50 border border-rose-100 rounded-xl p-4 mb-4">
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <span class="block text-xs text-rose-600 mt-0.5">Jika dicentang, data sales lama akan
                                    dihapus total.</span>
                            </div>
                        </label>
                    </div>
