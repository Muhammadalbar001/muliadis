<div class="space-y-4" x-data="{ activeGroup: 'general' }">
    ...
    <div class="bg-white border border-gray-300 shadow-sm rounded-lg flex flex-col">
        <!-- Container utama overflow-x-auto, hapus h-[70vh] untuk natural height -->
        <div class="flex-1 overflow-x-auto overflow-y-auto" style="max-height: 70vh;">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 sticky top-0 z-20">
                    <tr>
                        ...
                        <template x-if="activeGroup === 'meta'">
                            ...
                            <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">Unique</th>
