        ...
        <div class="flex-1 overflow-auto">
            <table class="w-full text-xs text-left border-collapse whitespace-nowrap">
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    ...
                    <tr
                        class="transition-colors group {{ $item->is_duplicate ? 'bg-yellow-100 hover:bg-yellow-200' : 'hover:bg-indigo-50' }}">

                        <td
                            class="px-3 py-2 border-r text-center text-gray-500 sticky left-0 z-10 {{ $item->is_duplicate ? 'bg-yellow-100 group-hover:bg-yellow-200' : 'bg-white group-hover:bg-indigo-50' }}">
                            {{ $produks->firstItem() + $index }}
                        </td>
                        <td
                            class="px-3 py-2 border-r text-center sticky left-[50px] z-10 shadow-sm {{ $item->is_duplicate ? 'bg-yellow-100 group-hover:bg-yellow-200' : 'bg-white group-hover:bg-indigo-50' }}">
                            ...
                            <div class="text-[10px] text-red-600 font-bold mt-1">DUPLIKAT</div>
                            @endif
                        </td>
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="text-sm text-gray-600">
                                            <label for="file-upload-prod-{{ $iteration }}"
                                                ...
                                                <input id="file-upload-prod-{{ $iteration }}" wire:model="file"
