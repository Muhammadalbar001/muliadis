            ...
            <table class="w-full text-sm text-left border-collapse">
                <thead class="text-gray-500 uppercase bg-gray-50 font-bold border-b border-gray-200 text-xs">
                    <tr>
                        ...
                        <th class="px-6 py-4 border-r text-right">Target IMS</th>
                        <th class="px-6 py-4 border-r text-right">Target OA</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-indigo-50 transition-colors">
                        ...
                        <td class="px-6 py-3 border-r text-right font-mono text-gray-700">
                            {{ number_format((float)$item->target_ims, 0, ',', '.') }}
                        </td>
                        <td class="px-6 py-3 border-r text-right font-mono text-gray-700">
                            {{ number_format((float)$item->target_oa, 0, ',', '.') }}
                        </td>
