        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <button @click="open = !open" @click.outside="open = false"
                    class="w-full pl-3 pr-8 py-2.5 text-left border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-indigo-500/20 bg-white hover:border-indigo-300 transition-colors flex items-center justify-between">
                ...
                <div x-show="open"
                    ...
                    <label
                        class="flex items-center px-2 py-1.5 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <button @click="open = !open" @click.outside="open = false"
                    class="w-full pl-3 pr-8 py-2.5 text-left border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-indigo-500/20 bg-white hover:border-indigo-300 transition-colors flex items-center justify-between">
                    <span class="truncate text-slate-700">
                        {{ empty($filterSupplier) ? 'Semua Supplier' : count($filterSupplier) . ' Dipilih' }}
                    </span>
                    <i class="fas fa-chevron-down text-[10px] text-slate-400"></i>
                </button>
                <div x-show="open"
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <button @click="open = !open" @click.outside="open = false"
                    class="w-full pl-3 pr-8 py-2.5 text-left border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-indigo-500/20 bg-white hover:border-indigo-300 transition-colors flex items-center justify-between">
                    <span class="truncate text-slate-700">
                        {{ empty($filterKategori) ? 'Semua Kategori' : count($filterKategori) . ' Dipilih' }}
                    </span>
                    <i class="fas fa-chevron-down text-[10px] text-slate-400"></i>
                </button>
                <div x-show="open"
                    ...
                    <label
                        class="flex items-center px-2 py-1.5 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors">
                        <input type="checkbox" value="{{ $k }}" wire:model.live="filterKategori"
                            class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4 mr-2">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <button @click="open = !open" @click.outside="open = false"
                    class="w-full pl-3 pr-8 py-2.5 text-left border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-indigo-500/20 bg-white hover:border-indigo-300 transition-colors flex items-center justify-between">
                    <span class="truncate text-slate-700">
                        {{ empty($filterDivisi) ? 'Semua Divisi' : count($filterDivisi) . ' Dipilih' }}
                    </span>
                    <i class="fas fa-chevron-down text-[10px] text-slate-400"></i>
                </button>
                <div x-show="open"
                    ...
                    <label
                        class="flex items-center px-2 py-1.5 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors">
                        <input type="checkbox" value="{{ $d }}" wire:model.live="filterDivisi"
                            class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4 mr-2">
            ...
            <div class="relative">
                ...
                <select wire:model.live="filterStok"
                    class="w-full pl-3 pr-8 py-2.5 border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-slate-700 appearance-none cursor-pointer bg-white hover:border-indigo-300 transition-colors">
                    <option value="">Semua Status</option>
                    <option value="ready">✅ Ready Stock</option>
                    <option value="empty">❌ Stok Kosong</option>
                </select>
                <div class="absolute right-3 bottom-3 text-slate-400 pointer-events-none"><i
                        class="fas fa-chevron-down text-[10px]"></i></div>
            </div>

            <div class="flex items-end">
                <button wire:click="resetFilter"
                    class="w-full py-2.5 bg-white hover:bg-rose-50 text-slate-500 hover:text-rose-600 text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 border border-slate-200 hover:border-rose-200 shadow-sm h-[42px]">
