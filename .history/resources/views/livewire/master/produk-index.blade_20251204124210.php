            ...
            <div class="w-full md:w-auto bg-gray-50 p-3 rounded-lg border border-dashed border-gray-300">
                <form wire:submit.prevent="import" class="flex flex-col md:flex-row gap-3 items-center">
                    ...
                    <div class="relative group">
                        <input type="file" wire:model="file" id="upload_{{ $iteration }}" class="block w-full text-sm text-slate-500
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-blue-50 transition duration-150">
                    ...
                    <td class="px-6 py-4">
                        <span
                            class="bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded border border-gray-500">
                            {{ $item->kategori }}
                        </span>
                    </td>
                    <td class="px-6 py-4 text-center">
                        <span
                            class="px-3 py-1 {{ $item->stok > 10 ? 'bg-green-100 text-green-800 border-green-400' : 'bg-red-100 text-red-800 border-red-400' }} border rounded-full text-xs font-bold">
                            {{ number_format($item->stok, 0) }}
                        </span>
                    </td>
                    <td class="px-6 py-4 text-right font-mono text-gray-700">Rp
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-gray-400 bg-gray-50">
                        <div class="flex flex-col items-center justify-center gap-3">
                            ...
                            <p class="text-sm max-w-sm">Silakan upload file Excel (Format .xlsx / .csv) melalui form di
