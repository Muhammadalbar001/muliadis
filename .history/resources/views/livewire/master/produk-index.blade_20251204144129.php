            ...
            <table class="min-w-max text-xs text-left border-collapse table-auto">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 sticky top-0 z-20">
                    <tr>
                        ...
                        <th
                            class="px-2 py-2 border-b border-r bg-gray-100 sticky left-[180px] z-30 min-w-[200px] whitespace-nowrap">
                            Nama Item</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-150">
                        ...
                        <td class="px-2 py-1 border-r bg-white sticky left-[80px] z-10 font-mono whitespace-nowrap">
                            {{ $item->sku }}</td>
                        <td class="px-2 py-1 border-r bg-white sticky left-[180px] z-10 text-gray-900 truncate max-w-[200px] whitespace-nowrap"
