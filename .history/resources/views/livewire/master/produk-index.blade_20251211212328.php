<div class="space-y-6 font-jakarta">
    ...
    <div
        class="sticky top-0 z-40 backdrop-blur-md bg-slate-100/90 p-4 rounded-b-2xl shadow-sm border-b border-slate-200 transition-all duration-300 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 mb-6">
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">

            <div class="flex items-center gap-4 w-full xl:w-auto">
                <div class="p-2 bg-white rounded-lg text-slate-600 shadow-sm">
                    <i class="fas fa-box text-xl"></i>
                </div>
                <div>
                    <h1 class="text-xl font-extrabold text-slate-800 tracking-tight">Master Produk</h1>
                    <p class="text-xs text-slate-500 font-medium mt-0.5">Database katalog barang.</p>
                </div>
            </div>
            <div
        ...
        <table class="text-[10px] text-left border-collapse whitespace-nowrap min-w-max w-full">
            <thead
                ...
                <tr>
                    ...
                    <th class="px-3 py-3 border-r border-blue-100 bg-blue-50 text-blue-700 text-right font-extrabold">
                        Stok</th>
                    ...
                    <th class="px-3 py-3 border-r border-slate-200 bg-slate-50 text-right">Re Qty</th>
