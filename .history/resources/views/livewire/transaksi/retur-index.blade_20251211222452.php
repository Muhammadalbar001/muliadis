        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex flex-wrap sm:flex-nowrap gap-2 items-center w-full xl:w-auto justify-end">
                ...
                <button wire:click="openImportModal"
                    class="px-3 py-2 bg-gradient-to-r from-rose-600 to-pink-600 text-white rounded-lg text-xs font-bold hover:from-rose-700 hover:to-pink-700 shadow-md shadow-rose-500/20 flex items-center gap-2"><i
