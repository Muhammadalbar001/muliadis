                ...
                <div class="px-6 py-6">
                    ...
                    <div class="bg-rose-50 border border-rose-100 rounded-xl p-4 mb-4">
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <div>
                                <span class="block text-sm font-bold text-rose-700">Hapus Data Lama?</span>
                                <span class="block text-xs text-rose-600 mt-0.5">Jika dicentang, semua data penjualan
