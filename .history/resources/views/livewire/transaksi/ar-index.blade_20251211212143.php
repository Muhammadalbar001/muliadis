<div class="space-y-6 font-jakarta">
    ...
    <div class="sticky top-0 z-40 backdrop-blur-md bg-orange-50/90 p-4 rounded-b-2xl shadow-sm border-b border-orange-200 transition-all duration-300 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 mb-6">
