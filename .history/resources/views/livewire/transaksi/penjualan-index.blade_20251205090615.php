    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="w-full md:w-auto bg-blue-50 p-3 rounded-lg border border-blue-200"
                ...
                <!-- DIV Pembungkus (Bukan Form) -->
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col md:flex-row gap-2 items-center">
                        <div class="relative">
                            <!-- INPUT FILE -->
                            <!-- id="upload_{{ $iteration }}" penting untuk mereset input setelah sukses -->
                        ...
                        <!-- TOMBOL IMPORT -->
                        <!-- wire:loading.attr="disabled": Mati saat proses PHP berjalan -->
                        <!-- :disabled="isUploading": Mati saat proses upload file berjalan -->
                    ...
                    <!-- PROGRESS BAR VISUAL -->
                    <!-- Hanya muncul saat file sedang dikirim ke server -->
                    ...
                    <div x-show="isUploading" class="text-xs text-blue-600 text-center mt-1 animate-pulse">
                        Sedang mengunggah file besar ke server...
                    </div>
                </div>
            </div>
            @endif
        ...
        <div class="flex-1 overflow-x-auto overflow-y-auto min-w-full" style="max-height: calc(100vh - 200px);">
            <table class="min-w-max text-xs text-left border-collapse table-auto">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 sticky top-0 z-20">
                    <tr>
                        <!-- Header 51 Kolom (Disalin dari kode sebelumnya) -->
                        ...
                        <!-- ... (Sisanya sama seperti file sebelumnya agar hemat karakter) ... -->
                        <!-- Pastikan Anda menyalin header lengkap dari kode sebelumnya -->
