    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-2">
        ...
        <div
            ...
            <div class="relative z-10">
                <p class="text-orange-100 text-[10px] font-bold uppercase tracking-wider mb-0.5">Total Sisa Piutang</p>
            ...
            <div class="absolute right-3 top-3 text-white/20 group-hover:scale-110 transition-transform duration-500">
                <i class="fas fa-hand-holding-usd text-5xl rotate-12"></i>
            </div>
        </div>
        ...
        <div
            ...
            <div
                class="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center text-red-500 group-hover:bg-red-500 group-hover:text-white transition-all">
        ...
        <div
            ...
            <div>
                ...
                <span
                    class="text-[9px] text-orange-600 font-bold bg-orange-50 px-1.5 py-0.5 rounded border border-orange-100">Belum
                    Lunas</span>
            </div>
            <div
                class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-slate-800 group-hover:text-white transition-all">
