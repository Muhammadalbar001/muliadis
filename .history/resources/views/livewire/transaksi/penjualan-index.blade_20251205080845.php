<div class="space-y-4">
    ...
    <div>
        ...
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 shadow mb-4">
            <p class="font-bold"><i class="fas fa-exclamation-circle"></i> Validasi:</p>
            <p>{{ $message }}</p>
        </div>
        @enderror
    </div>
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            @if (!$isLaporanMode)
            <!-- REVISI: Tambahkan 'hasFile: false' untuk mendeteksi file -->
            <div class="w-full md:w-auto bg-blue-50 p-3 rounded-lg border border-blue-200"
                ...
                <!-- REVISI: Ganti <form> dengan <div> biasa agar tidak refresh halaman -->
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col md:flex-row gap-2 items-center">
                        <div class="relative">
                            <!-- Input File: Tambahkan @change untuk deteksi file dipilih -->
                        ...
                        <!-- Tombol Import:
                             1. type="button" (Wajib)
                             2. wire:click="import"
                             3. :disabled="!hasFile || isUploading" (Tombol Mati jika tidak ada file) 
                        -->
    ...
    <!-- 3. KONTEN TABEL -->
    <!-- (Biarkan kode tabel di bawah ini sama seperti sebelumnya, tidak ada perubahan) -->
        ...
        <div class="flex-1 overflow-x-auto overflow-y-auto min-w-full" style="max-height: calc(100vh - 200px);">
            <table class="min-w-max text-xs text-left border-collapse table-auto">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 sticky top-0 z-20">
                    <tr>
                        <!-- 51 Kolom Header (Sama seperti sebelumnya) -->
