<div class="space-y-6 font-jakarta">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500">Input data pelunasan/pembayaran toko harian.</p>
        </div>
    ...
    @if($isImportOpen)
    @include('livewire.partials.import-modal', ['title'=>'Import Data Collection', 'color'=>'blue'])
    @endif
