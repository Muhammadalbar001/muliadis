<div class="space-y-4">
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="w-full md:w-auto bg-blue-50 p-3 rounded-lg border border-blue-200"
                ...
                x-on:livewire-upload-finish="isUploading = false; hasFile = true"
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col md:flex-row gap-2 items-center">
                        <div class="relative">
                            <!-- Input File:
                                 - wire:model.live untuk Livewire v3 stream upload
                                 - wire:key untuk me-refresh input saat iteration berubah
                                 - change event menjaga hasFile on non-live situations
                            -->
                            <input type="file" wire:model.live="file" wire:key="file-{{ $iteration }}"
                                id="upload_{{ $iteration }}" x-on:change="hasFile = $event.target.files.length > 0"
                        ...
                        <!-- Tombol Import:
                             - :disabled dikontrol Alpine (hasFile / isUploading)
                             - wire:loading.class menambahkan class saat Livewire sedang proses import
                        -->
    ...
    <!-- 3. KONTEN TABEL (Ringkas Operasional) -->
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-150">
                        ...
                        <td class="px-4 py-3 max-w-xs truncate" title="{{ $item->nama_item }}"><span
                                class="font-medium">{{ $item->nama_item }}</span><br><span class="text-xs text-gray-500 bg-gray-100