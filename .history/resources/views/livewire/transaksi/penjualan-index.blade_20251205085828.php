                ...
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col md:flex-row gap-2 items-center">
                        ...
                        <button type="button" wire:click="import" wire:loading.attr="disabled"
                            ...
                            <!-- Tampil saat normal -->
                            <span wire:loading.remove wire:target="file, import">
                                <i class="fas fa-upload"></i> Import Penjualan
                            </span>

                            <!-- Tampil saat file sedang di-upload -->
                            <span wire:loading wire:target="file">
                                <i class="fas fa-spinner fa-spin"></i> Uploading...
                            </span>

                            <!-- Tampil saat tombol import ditekan (Proses DB) -->
                    ...
                    <!-- Indikator Loading Tambahan (Bar Biru) -->
                    <div wire:loading wire:target="file"
                        class="w-full bg-gray-200 rounded-full h-2.5 mt-1 overflow-hidden">
                        <div class="bg-blue-600 h-2.5 rounded-full animate-pulse" style="width: 100%"></div>
                    </div>
                    <div wire:loading wire:target="file" class="text-xs text-blue-600 text-center">
                        Sedang mengunggah ke server... Mohon tunggu.
                    </div>
                </div>
            </div>
            @endif
