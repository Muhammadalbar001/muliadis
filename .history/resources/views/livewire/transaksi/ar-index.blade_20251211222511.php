        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex flex-wrap sm:flex-nowrap gap-2 items-center w-full xl:w-auto justify-end">
                ...
                <button wire:click="openImportModal"
                    class="px-3 py-2 bg-gradient-to-r from-orange-500 to-amber-600 text-white rounded-lg text-xs font-bold hover:from-orange-600 hover:to-amber-700 shadow-md shadow-orange-500/20 flex items-center gap-2"><i
                        class="fas fa-file-invoice-dollar"></i> <span class="hidden sm:inline">Import</span></button>
