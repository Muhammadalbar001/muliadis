<div class="space-y-4">
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <!-- Pencarian -->
            <div class="w-full @if(!$isLaporanMode) md:w-1/3 @else md:w-2/3 @endif relative">
            ...
            <!-- Form Upload (Hanya tampil di mode Order/Transaksi) -->
            @if (!$isLaporanMode)
            ...
            @else
            <!-- Tombol Export/Filter Laporan (Placeholder) -->
            <button
    ...
    <!-- TABEL DATA 51 KOLOM (RESPONSIVE & SCROLLABLE) -->
        ...
        <div class="flex-1 overflow-x-auto overflow-y-auto min-w-full" style="max-height: calc(100vh - 200px);">
            <table class="min-w-max text-xs text-left border-collapse table-auto">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 sticky top-0 z-20">
                    <tr>
                        <!-- === URUTAN KOLOM SESUAI EXCEL (1 - 13) === -->
                        <th class="px-2 py-2 border-b border-r bg-gray-100 min-w-[80px] whitespace-nowrap">Cabang</th>
                        <th class="px-2 py-2 border-b border-r min-w-[120px] whitespace-nowrap">Trans No</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Status</th>
                        <th class="px-2 py-2 border-b border-r min-w-[90px] whitespace-nowrap">Penjualan (Tgl)</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Period</th>
                        <th class="px-2 py-2 border-b border-r min-w-[90px] whitespace-nowrap">Jatuh Tempo</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Kode Pel.</th>
                        <th class="px-2 py-2 border-b border-r min-w-[150px] whitespace-nowrap">Nama Pelanggan</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Kode Item</th>
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">SKU</th>
                        <th class="px-2 py-2 border-b border-r min-w-[90px] whitespace-nowrap">No Batch</th>
                        <th class="px-2 py-2 border-b border-r min-w-[90px] whitespace-nowrap">ED</th>
                        <th class="px-2 py-2 border-b border-r min-w-[200px] whitespace-nowrap">Nama Item</th>

                        <!-- === QTY & NILAI (14 - 22) === -->
                        <th class="px-2 py-2 border-b border-r min-w-[60px] whitespace-nowrap">Qty</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Satuan Jual</th>
                        <th class="px-2 py-2 border-b border-r min-w-[60px] whitespace-nowrap">Qtyi</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Satuani</th>
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">Nilai</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">RATA2</th>
                        ...
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">N. Jual+Pembultn</th>
                        ...
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Diskon1</th>
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">Diskon2</th>
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">Diskon Bawah</th>
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">T. Diskon</th>
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">N. Jual- T. Diskon</th>
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">Total Harga Jual</th>

                        <!-- === TOTALS & MARGIN (31 - 35) === -->
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">PPN Head</th>
                        <th class="px-2 py-2 border-b border-r min-w-[100px] font-bold bg-green-50 whitespace-nowrap">
                            TOTAL</th>
                        ...
                        <th class="px-2 py-2 border-b border-r min-w-[80px] whitespace-nowrap">ID (TRX)</th>
                        ...
                        <!-- === META (45 - 51) === -->
                        <th class="px-2 py-2 border-b border-r min-w-[150px] whitespace-nowrap">Last Suppliers</th>
                        ...
                        <th class="px-2 py-2 border-b border-r min-w-[150px] whitespace-nowrap">Outlet & Sales Name</th>
                        <th class="px-2 py-2 border-b border-r min-w-[150px] whitespace-nowrap">City & Code & Program
                        </th>
                        <th class="px-2 py-2 border-b border-r min-w-[150px] whitespace-nowrap">Sales Name & Outlet Code
                        </th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-150">
                        ...
                        <td class="px-2 py-1 border-r text-gray-500 whitespace-nowrap">{{ $item->status }}</td>
