            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors group">
                        ...
                        <td class="px-6 py-4 font-mono text-emerald-600 font-medium">
                            {{ $item->invoice_no }}
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @if($item->bank_acc)
                            <div class="text-xs text-gray-400 mt-1">{{ $item->bank_acc }}</div>
                            @endif
                        </td>
                        <td class="px-6 py-4 text-right text-red-400 text-xs">
                            {{ (float)$item->discount > 0 ? '- Rp '.number_format((float)$item->discount,0,',','.') : '-' }}
                        </td>
                        <td class="px-6 py-4 text-right font-bold text-gray-800">
                            Rp {{ number_format((float)$item->total_payment, 0, ',', '.') }}
                        </td>
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                    <button wire:click="import" wire:loading.attr="disabled"
                        class="w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2 bg-emerald-600 text-base font-medium text-white hover:bg-emerald-700 sm:ml-3 sm:w-auto sm:text-sm">Import</button>
