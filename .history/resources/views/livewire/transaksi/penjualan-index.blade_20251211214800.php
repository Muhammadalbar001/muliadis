<div class="space-y-6 font-jakarta">
        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex items-center gap-4 w-full xl:w-auto">
                ...
                <div>
                    ...
                    <p class="text-xs text-emerald-600 font-medium mt-0.5">Rekapitulasi faktur penjualan harian.</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-2">
        ...
        <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-4 text-white shadow-sm shadow-emerald-500/20 relative overflow-hidden group">
            <div class="relative z-10">
                <p class="text-emerald-100 text-[10px] font-bold uppercase tracking-wider mb-0.5">Total Omzet</p>
                <h3 class="text-xl font-extrabold tracking-tight">Rp {{ number_format($summary['total_omzet'], 0, ',', '.') }}</h3>
            </div>
            <div class="absolute right-3 top-3 text-white/20 group-hover:scale-110 transition-transform duration-500">
                <i class="fas fa-chart-line text-5xl rotate-12"></i>
            </div>
        </div>

        <div class="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex items-center justify-between group hover:border-emerald-300 transition-colors">
            <div>
                ...
                <span class="text-[9px] text-emerald-600 font-bold bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-100">Transaksi</span>
            </div>
        ...
        <div class="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex items-center justify-between group hover:border-orange-300 transition-colors">
            <div>
                ...
                <span class="text-[9px] text-orange-600 font-bold bg-orange-50 px-1.5 py-0.5 rounded border border-orange-100">SKU / Pcs</span>
            </div>
            <div class="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 group-hover:bg-orange-500 group-hover:text-white transition-all">
