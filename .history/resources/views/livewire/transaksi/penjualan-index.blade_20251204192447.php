<div class="space-y-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="w-full {{ !$isLaporanMode ? 'md:w-1/3' : 'md:w-2/3' }} relative">
                ...
                <input type="text" wire:model.live.debounce.300ms="search"
                    placeholder="Cari No Transaksi, Pelanggan, atau Sales..."
            ...
            <!-- Form Upload (Hanya Muncul di Mode Order Penjualan) -->
            @if (!$isLaporanMode)
            <div class="w-full md:w-auto bg-blue-50 p-2 rounded-lg border border-blue-200">
                ...
                <div wire:loading wire:target="file" class="text-xs text-blue-600 mt-1 pl-1">
    ...
    <!-- ======================================================= -->
    <!-- TAMPILAN A: MODE ORDER PENJUALAN (Ringkas & Operasional) -->
    <!-- ======================================================= -->
    @if (!$isLaporanMode)
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-150">
                        ...
                        <td class="px-4 py-3 max-w-xs truncate" title="{{ $item->nama_item }}">
                            ...
                            <br>
                            <span class="text-xs text-gray-500 bg-gray-100 px-1 rounded">{{ $item->sku }}</span>
                        </td>
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            'canceled', 'batal' => 'bg-red-100 text-red-800',
                            default => 'bg-blue-100 text-blue-800'
                            };
                            @endphp
                            <span
                                class="{{ $statusColor }} text-xs font-medium px-2.5 py-0.5 rounded border border-gray-200">
                                {{ $item->status ?? 'N/A' }}
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-12 text-center text-gray-400 bg-gray-50">
                            <div class="flex flex-col items-center justify-center gap-3">
                                ...
                                <h3 class="text-lg font-bold text-gray-600">Tidak Ada Order Penjualan</h3>
                                <p class="text-sm">Gunakan tombol Import di atas untuk memasukkan data transaksi.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
    ...
    <!-- ======================================================= -->
    <!-- TAMPILAN B: MODE REKAP PENJUALAN (Detail 51 Kolom)   -->
    <!-- ======================================================= -->
    @else
                    ...
                    <tr>
                        <td colspan="51" class="px-6 py-12 text-center text-gray-400 bg-gray-50">
                            <div class="flex flex-col items-center justify-center gap-3">
                                ...
                                <p class="text-sm max-w-sm">Data Rekap Penjualan akan muncul di sini setelah Anda
                                    melakukan import di menu Order Penjualan.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
