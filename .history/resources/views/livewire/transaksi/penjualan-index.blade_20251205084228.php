<div class="space-y-4">
    ...
    <!-- CSS untuk mencegah kedipan elemen AlpineJS -->
    <style>
    [x-cloak] {
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="w-full md:w-auto bg-blue-50 p-3 rounded-lg border border-blue-200"
                ...
                <!-- Gunakan DIV biasa agar tidak refresh halaman -->
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col md:flex-row gap-2 items-center">
                        <div class="relative">
                            <!-- Input File: Deteksi perubahan agar tombol Import nyala -->
                    ...
                    <!-- Progress Bar (Hanya muncul saat uploading) -->
                    <div x-show="isUploading" x-transition
                        class="w-full bg-gray-200 rounded-full h-4 mt-2 border border-gray-300 overflow-hidden relative">
                        <!-- Bar Biru -->
                        <div class="bg-blue-600 h-4 rounded-full transition-all duration-300 flex items-center justify-center text-[10px] text-white font-bold"
                    ...
                    <div x-show="isUploading" class="text-xs text-blue-600 text-center animate-pulse">
                        Mohon tunggu, sedang mengunggah file besar...
                    </div>
                </div>
            </div>
            @endif
