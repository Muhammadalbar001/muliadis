<div class="space-y-6 font-jakarta">
            ...
            <div class="w-full md:flex-1 relative">
                ...
                <div class="relative">
                    ...
                    <input wire:model.live.debounce.300ms="search" type="text"
                        ...
                        placeholder="Cari No Bukti atau Nama Toko...">
                </div>
            </div>
            ...
            <table class="text-xs text-left border-collapse whitespace-nowrap w-full">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-4 py-3 border-r text-right bg-blue-50 text-blue-900">Jumlah Bayar</th>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-blue-50/30 transition-colors">
                        ...
                        <td class="px-4 py-2 border-r font-mono text-slate-700 font-bold">
                            {{ $item->receive_no }}
                        </td>
    ...
    @if($isImportOpen)
    @include('livewire.partials.import-modal', ['title'=>'Import Collection', 'color'=>'blue'])
    @endif
