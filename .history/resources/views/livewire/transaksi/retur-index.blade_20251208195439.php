<div class="space-y-6 font-jakarta">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h2 class="text-xl font-bold text-slate-800">Input Retur Barang</h2>
            <p class="text-sm text-slate-500">Monitoring barang kembali (Bad Stock/Expired) harian.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="md:col-span-2 relative">
                ...
                <input wire:model.live.debounce.300ms="search" type="text"
                    ...
                    placeholder="Cari No Retur atau Nama Toko...">
            </div>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-rose-50/30 transition-colors">
                        ...
                        <td class="px-4 py-2 border-r text-slate-500">
                            {{ $item->tgl_retur ? date('d/m/Y', strtotime($item->tgl_retur)) : '-' }}
                        </td>
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-12 text-center text-slate-400">
                            <div class="flex flex-col items-center justify-center">
                                <i class="fas fa-undo-alt text-3xl mb-3 text-rose-200"></i>
