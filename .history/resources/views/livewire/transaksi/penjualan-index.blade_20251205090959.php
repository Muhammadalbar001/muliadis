            ...
            <div class="w-full md:w-auto bg-blue-50 p-3 rounded-lg border border-blue-200"
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col md:flex-row gap-2 items-center">
                        <div class="relative">
                            <!-- INPUT FILE -->
                            <!-- x-on:change: KUNCI agar tombol import baru nyala setelah pilih file -->
                        ...
                        <!-- TOMBOL IMPORT -->
                        <!-- :disabled="!hasFile || isUploading": Mati jika tak ada file ATAU sedang upload -->
                        <button type="button" wire:click="import" wire:loading.attr="disabled"
                            ...
                            <!-- Icon Saat Upload File (Browser -> Server) -->
                    ...
                    <div x-show="isUploading" class="text-xs text-blue-600 text-center mt-1 animate-pulse">
                        Sedang mengunggah file besar ke server... Mohon tunggu.
                    </div>
                </div>
            </div>
            @endif
