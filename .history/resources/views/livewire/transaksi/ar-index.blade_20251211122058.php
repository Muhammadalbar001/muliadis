        ...
        <div class="flex flex-col md:flex-row gap-4 items-end">
            ...
            <div class="w-full md:w-48 relative" x-data="{ open: false }">
                ...
                <div x-show="open"
                    ...
                    <label
                        class="flex items-center px-2 py-2 hover:bg-orange-50 rounded-lg cursor-pointer transition-colors group">
                        <input type="checkbox" value="{{ $cab }}" wire:model.live="filterCabang"
                            class="rounded border-slate-300 text-orange-600 focus:ring-orange-500 h-4 w-4 mr-3 cursor-pointer">
                        <span class="text-xs font-medium text-slate-600 group-hover:text-orange-700">{{ $cab }}</span>
                    </label>
                    @endforeach
                </div>
            </div>
            ...
            <div class="w-full md:w-48">
                ...
                <div class="relative">
                    <select wire:model.live="filterUmur"
                        class="w-full pl-3.5 pr-8 py-2.5 border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 appearance-none cursor-pointer hover:border-orange-300 transition-all bg-white">
                        <option value="">Semua Status</option>
                        <option value="lancar">✅ Lancar (≤ 30 Hari)</option>
                        <option value="macet">⚠️ Macet (> 30 Hari)</option>
                    </select>
                    <i
                        class="fas fa-chevron-down absolute right-3 top-3.5 text-[10px] text-slate-400 pointer-events-none"></i>
                </div>
            </div>

            <button wire:click="resetFilter"
                class="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-xl transition-colors h-[42px] flex items-center justify-center gap-2"
                title="Reset Filter">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div
            ...
            <div>
                ...
                <span
                    class="text-[10px] text-red-500 font-bold bg-red-50 px-2 py-0.5 rounded-full mt-1 inline-block border border-red-100">
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-orange-50/20 transition-colors group">
                        ...
                        <td class="px-6 py-3 border-r border-slate-100 text-center">
                            ...
                            @if($umur > 30)
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-red-100 text-red-600 border border-red-200 shadow-sm">
                                {{ $umur }} Hari
                            </span>
                            @elseif($umur > 15)
                            <span
                    ...
                    @empty
                    <tr>
                        <td colspan="8" class="px-6 py-24 text-center text-slate-400">
