    ...
    <div
        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex items-center gap-4 w-full xl:w-auto">
                ...
                <div>
                    <h1 class="text-xl font-extrabold text-cyan-900 tracking-tight">Collection / Pelunasan</h1>
                    <p class="text-xs text-cyan-700 font-medium mt-0.5">Data pembayaran piutang.</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-2">
        ...
        <div
            ...
            <div>
                ...
                <span
                    class="text-[9px] text-cyan-600 font-bold bg-cyan-50 px-1.5 py-0.5 rounded border border-cyan-100">Slip
                    Pembayaran</span>
            </div>
            <div
                class="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all">
        ...
        <div
            ...
            <div>
                ...
                <span
                    class="text-[9px] text-green-600 font-bold bg-green-50 px-1.5 py-0.5 rounded border border-green-100">Invoice
                    Selesai</span>
            </div>
            <div
                class="w-10 h-10 rounded-xl bg-green-50 flex items-center justify-center text-green-600 group-hover:bg-green-500 group-hover:text-white transition-all">
