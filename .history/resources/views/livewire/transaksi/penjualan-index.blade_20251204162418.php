            ...
            <table class="min-w-max text-xs text-left border-collapse table-auto">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 sticky top-0 z-20">
                    <tr>
                        ...
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">PPN Head</th>
                        ...
                        <th class="px-2 py-2 border-b border-r min-w-[100px] whitespace-nowrap">Kode Sales</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-150">
                        <td class="px-2 py-1 border-r whitespace-nowrap">{{ $item->cabang }}</td>
