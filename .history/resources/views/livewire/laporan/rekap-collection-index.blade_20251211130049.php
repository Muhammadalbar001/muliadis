            ...
            <table class="text-[10px] text-left border-collapse whitespace-nowrap w-full">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200 bg-slate-50 sticky left-[60px] z-30">Receive No
                        </th>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200">Invoice No</th>
                        <th class="px-3 py-3 border-r border-slate-200">Code Customer</th>
                        <th class="px-3 py-3 border-r border-slate-200 min-w-[150px]">Outlet Name</th>
