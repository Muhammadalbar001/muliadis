    ...
    <div
        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            <div class="flex items-center gap-4 w-full xl:w-auto">
                <div class="p-2 bg-emerald-100 rounded-lg text-emerald-600 shadow-sm"><i
                        class="fas fa-chart-line text-xl"></i></div>
                <div>
            ...
            <div class="flex flex-wrap sm:flex-nowrap gap-2 items-center w-full xl:w-auto justify-end">
                ...
                <div class="w-full sm:w-32">
                    <select wire:model.live="filterCabang"
                        class="w-full border-white rounded-lg text-xs font-bold text-slate-700 focus:ring-emerald-500 py-2 shadow-sm cursor-pointer bg-white hover:bg-emerald-50">
        ...
        <div class="overflow-auto flex-1 w-full custom-scrollbar">
            <table class="text-[10px] text-left border-collapse whitespace-nowrap min-w-max w-full">
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    @empty
                    <tr>
                        <td colspan="36" class="px-6 py-12 text-center text-slate-400">Data tidak ditemukan</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
