<div class="space-y-6 font-jakarta">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Data detail penjualan ({{ $penjualans->total() }} Baris).</p>
        </div>
    ...
    <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 flex flex-wrap gap-4 items-end">
        <div class="flex-1 min-w-[200px]">
            ...
            <input wire:model.live.debounce.300ms="search" type="text"
                class="w-full border-slate-200 rounded-xl text-sm focus:ring-emerald-500"
                placeholder="Cari Faktur / Produk...">
        </div>
        <div class="w-auto">
            ...
            <table class="text-[10px] text-left border-collapse whitespace-nowrap w-full">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200 bg-slate-50 sticky left-[60px] z-30">No Faktur
                        </th>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200 min-w-[200px]">Nama Barang</th>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-emerald-50/20 transition-colors odd:bg-white even:bg-slate-50/50">
                        ...
                        <td
                            ...
                            {{ number_format($item->qty, 0, ',', '.') }} {{ $item->satuan_jual }}</td>
                        <td
                    ...
                    @empty
                    <tr>
                        <td colspan="9" class="px-6 py-12 text-center text-slate-400">Data tidak ditemukan</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
