        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex items-center gap-4 w-full xl:w-auto">
                ...
                <div>
                    ...
                    <p class="text-xs text-emerald-600 font-medium mt-0.5">Laporan detail penjualan (Excel Style).</p>
                </div>
                <div
                    class="hidden md:flex px-3 py-1 bg-white text-emerald-600 rounded-lg text-[10px] font-bold border border-emerald-100 items-center gap-2 shadow-sm">
                    <i class="fas fa-list-ol"></i> {{ $penjualans->total() }} Baris
                </div>
            </div>
            ...
            <div class="flex flex-wrap sm:flex-nowrap gap-2 items-center w-full xl:w-auto justify-end">
                ...
                <div class="relative w-full sm:w-48">
                    <div class="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
                        <i class="fas fa-search text-emerald-500/50 text-xs"></i>
                    </div>
                    <input wire:model.live.debounce.300ms="search" type="text"
                        class="pl-8 w-full border-white rounded-lg text-xs font-bold text-slate-700 focus:ring-emerald-500 py-2 shadow-sm placeholder-slate-400 transition-all"
                ...
                <div class="w-full sm:w-32">
                    <select wire:model.live="filterCabang"
                        class="w-full border-white rounded-lg text-xs font-bold text-slate-700 focus:ring-emerald-500 py-2 shadow-sm cursor-pointer bg-white hover:bg-emerald-50 transition-colors">
            ...
            <table class="text-[10px] text-left border-collapse whitespace-nowrap w-full">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200 text-right">Harga</th>
                        <th class="px-3 py-3 border-r border-slate-200 text-right text-rose-600">Diskon</th>
                        <th class="px-3 py-3 border-r border-slate-200 text-right">DPP</th>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-emerald-50/20 transition-colors odd:bg-white even:bg-slate-50/30">
                        ...
                        <td
                            class="px-3 py-2 border-r border-slate-100 text-right font-bold bg-emerald-50/30 text-emerald-700">
                    ...
                    @empty
                    <tr>
                        <td colspan="17" class="px-6 py-12 text-center text-slate-400">Data tidak ditemukan</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
