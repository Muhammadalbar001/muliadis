        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex items-center gap-4 w-full xl:w-auto">
                ...
                <div>
                    ...
                    <p class="text-xs text-cyan-700 font-medium mt-0.5">Detail pelunasan piutang (Excel Style).</p>
                </div>
                <div
                    class="hidden md:flex px-3 py-1 bg-white text-cyan-600 rounded-lg text-[10px] font-bold border border-cyan-100 items-center gap-2 shadow-sm">
                    <i class="fas fa-list-ol"></i> {{ $collections->total() }} Baris
                </div>
            </div>
            ...
            <div class="flex flex-wrap sm:flex-nowrap gap-2 items-center w-full xl:w-auto justify-end">
                ...
                <div class="relative w-full sm:w-48">
                    <div class="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
                        <i class="fas fa-search text-cyan-500/50 text-xs"></i>
                    </div>
                    <input wire:model.live.debounce.300ms="search" type="text"
                        class="pl-8 w-full border-white rounded-lg text-xs font-bold text-slate-700 focus:ring-cyan-500 py-2 shadow-sm placeholder-slate-400 transition-all"
                ...
                <div class="w-full sm:w-32">
                    <select wire:model.live="filterCabang"
                        class="w-full border-white rounded-lg text-xs font-bold text-slate-700 focus:ring-cyan-500 py-2 shadow-sm cursor-pointer bg-white hover:bg-cyan-50 transition-colors">
