        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="p-8 text-center text-slate-400">Tidak ada data. Cek filter bulan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-3 text-right font-mono">{{ number_format($row['total_ar'], 0, ',', '.') }}
                        </td>
