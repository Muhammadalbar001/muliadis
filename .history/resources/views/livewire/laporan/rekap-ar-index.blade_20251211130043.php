            ...
            <table class="text-[10px] text-left border-collapse whitespace-nowrap w-full">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200 bg-slate-50 sticky left-[60px] z-30">No Penjualan
                        </th>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200 text-right">LE 15 Hari</th>
                        ...
                        <th class="px-3 py-3 border-r border-slate-200">Alamat</th>
                        <th class="px-3 py-3 border-r border-slate-200">Phone</th>
                        <th class="px-3 py-3 border-r border-slate-200 text-center">Umur Piutang</th>
                        <th class="px-3 py-3 border-r border-slate-200">Unique ID</th>
                        <th class="px-3 py-3 border-r border-slate-200 text-right">LT 14 Hari</th>
                        <th class="px-3 py-3 border-r border-slate-200 text-right">14-30 Hari</th>
                        <th class="px-3 py-3 border-r border-slate-200 text-right">UP 30 Hari</th>
                        <th class="px-3 py-3 border-r border-slate-200">Range Piutang</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-orange-50/20 transition-colors odd:bg-white even:bg-slate-50/50">
                        ...
                        <td class="px-3 py-2 border-r border-slate-100 text-[9px]">{{ $item->unique_id }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="25" class="px-6 py-12 text-center text-slate-400">Data AR kosong</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
