    ...
    <div class="bg-white p-5 rounded-2xl shadow-sm border border-indigo-100 flex flex-col md:flex-row justify-between items-end gap-4">
        <div class="flex gap-4 w-full md:w-auto">
            <div class="w-full md:w-40">
                ...
                <select wire:model.live="filterBulan" class="w-full border-indigo-100 rounded-xl text-sm focus:ring-indigo-500 font-bold text-indigo-700">
            ...
            <div class="w-full md:w-32">
                ...
                <select wire:model.live="filterTahun" class="w-full border-indigo-100 rounded-xl text-sm focus:ring-indigo-500 font-bold text-indigo-700">
            ...
            <div class="w-full md:w-48">
                ...
                <select wire:model.live="filterCabang" class="w-full border-indigo-100 rounded-xl text-sm focus:ring-indigo-500 text-slate-700">
