        ...
        <div class="flex flex-col xl:flex-row gap-4 items-center justify-between">
            ...
            <div class="flex flex-wrap sm:flex-nowrap gap-2 items-center w-full xl:w-auto justify-end">
                ...
                <button wire:click="applyFilter"
                    class="h-[38px] px-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold shadow-sm flex items-center gap-2 transition-all disabled:opacity-50">
...
document.addEventListener('livewire:init', () => {
    let charts = {};
    // Ambil data inisial dari render pertama (Lazy load akan mengisi ini di pass kedua)
    ...
    // Render awal jika data ada
    if (initData) renderCharts(initData);

    // Dengar event 'update-charts' dari backend (saat tombol Cari ditekan)
