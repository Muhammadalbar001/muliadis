    ...
    const initChart = (data) => {
        ...
        charts.salesRetur = new Chart(ctxSR, {
            ...
            data: {
                labels: labels,
                datasets: [
                    { label: 'Penjualan', data: data.sales, borderColor: '#6366f1', backgroundColor: 'rgba(99, 102, 241, 0.1)', fill: true, tension: 0.3 },
                    { label: 'Retur', data: data.retur, borderColor: '#ef4444', backgroundColor: 'rgba(239, 68, 68, 0.1)', fill: true, tension: 0.3 }
                ]
            },
        ...
        charts.arColl = new Chart(ctxAC, {
            ...
            data: {
                labels: labels,
                datasets: [
                    { label: 'Piutang Baru', data: data.ar, backgroundColor: '#f97316' },
