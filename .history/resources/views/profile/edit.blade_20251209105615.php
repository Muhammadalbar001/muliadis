    ...
    <div class="py-12 font-jakarta">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                ...
                <div class="p-6 sm:p-8 bg-white shadow-sm rounded-2xl border border-indigo-50">
                    <div class="max-w-xl">
                ...
                <div class="p-6 sm:p-8 bg-red-50 shadow-sm rounded-2xl border border-red-100 lg:col-span-2">
                    <div class="max-w-xl">
