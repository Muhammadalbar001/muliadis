<x-guest-layout>
    <div class="flex min-h-screen">
        ...
        <div class="hidden md:flex md:w-1/2 lg:w-5/12 bg-slate-900 relative overflow-hidden flex-col justify-between p-12 text-white">
            
            <div class="absolute inset-0 z-0">
                <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=2070&auto=format&fit=crop" 
                     alt="Warehouse Background" 
                     class="w-full h-full object-cover opacity-30">
                <div class="absolute inset-0 bg-gradient-to-br from-indigo-900/90 to-slate-900/90 mix-blend-multiply"></div>
            </div>
            ...
            <div class="relative z-10 mb-10">
                ...
                <p class="text-slate-300 text-lg font-light leading-relaxed">
                    Kelola ribuan SKU, pantau penjualan harian, dan kontrol piutang dengan presisi tinggi dalam satu dashboard terintegrasi.
                </p>
            </div>
        ...
        <div class="w-full md:w-1/2 lg:w-7/12 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md space-y-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <button type="submit" class="w-full py-3.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-600/20 hover:shadow-indigo-600/40 transition-all transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Masuk Dashboard
                    </button>
                    
                    <div class="text-center mt-6">
                        <p class="text-xs text-slate-400">
                            Mengalami kendala akses? <a href="#" class="text-indigo-600 hover:text-indigo-500 font-medium">Hubungi IT Support</a>
                        </p>
                    </div>
                </form>
            </div>
