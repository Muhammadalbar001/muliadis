...
<body class="bg-white overflow-hidden">
    ...
    <div class="flex min-h-screen" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-24 py-12 relative z-10 bg-white"
            ...
            <div class="mb-10">
                ...
                <p class="text-slate-500 mt-3 text-sm leading-relaxed">
                    Masukkan alamat email Anda dan kami akan mengirimkan tautan reset password.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-end mt-4">
                    <button type="submit"
                        class="w-full py-3.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 transition-all hover:-translate-y-1">
                        Kirim Link Reset
                    </button>
                </div>
            </form>
        ...
        <div class="hidden lg:block lg:w-1/2 relative bg-slate-900" x-show="show"
            ...
            <div class="absolute inset-0 flex flex-col justify-between p-20 z-20">
                ...
                <div class="text-white max-w-lg">
                    <h3 class="text-3xl font-bold leading-tight mb-4">Keamanan Akun Prioritas Kami.</h3>
