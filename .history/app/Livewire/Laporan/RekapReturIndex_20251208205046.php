...
class RekapReturIndex extends Component
{
    ...
    public $filterCabang = [];
    public $filterSales = [];
    public $filterSupplier = []; // Baru
    public $filterDivisi = [];   // Baru
    public $filterStatus = [];   // Baru (Potong Faktur, Ganti Barang, dll)
    ...
    public function render()
    {
        ...
        return view('livewire.laporan.rekap-retur-index', compact('data', 'optCabang', 'optSales', 'optSupplier', 'optDivisi', 'optStatus'))
