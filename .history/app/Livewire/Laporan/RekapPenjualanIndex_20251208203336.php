...
class RekapPenjualanIndex extends Component
{
    ...
    public function render()
    {
        ...
        $data = $query->orderBy('tgl_penjualan', 'desc')->paginate(20); // 20 per halaman biar enak rekap
        ...
        return view('livewire.laporan.rekap-penjualan-index', compact('data', 'optCabang', 'optSales'))
