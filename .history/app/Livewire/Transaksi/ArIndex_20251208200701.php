...
class ArIndex extends Component
{
    ...
    public function render()
    {
        ...
        // Urutkan yang macet terparah dulu
        ...
        return view('livewire.transaksi.ar-index', compact('ars', 'optCabang', 'optSales'))
            ->layout('layouts.app', ['header' => 'Monitoring Piutang (AR)']);
    }

    // ... (Fungsi Import & Delete SAMA) ...
    ...
    public function import() {
        ...
        try {
            ...
            (new ArImportService)->handle(storage_path('app/'.$path)); 
            $this->dispatch('show-toast', ['type' => 'success', 'title' => 'Sukses', 'message' => 'Data AR berhasil diimport']);
