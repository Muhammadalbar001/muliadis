...
class ReturIndex extends Component
{
    ...
    // Rule validasi standar
    protected $rules = [
        'file' => 'required|file|mimes:xlsx,csv,xls|max:512000', // 500MB
    ];
    ...
    {
        // 1. CEK MANUAL: Pastikan file sudah terisi
        if (!$this->file) {
        ...
        try {
            ...
            $msg = "Import Selesai! Total Baris: {$stats['total_rows']}. Sukses Masuk: {$stats['imported']}.";
