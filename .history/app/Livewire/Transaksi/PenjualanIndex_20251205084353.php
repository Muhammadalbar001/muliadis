...
class PenjualanIndex extends Component
{
    ...
    // [FIX] Properti ini WAJIB ADA karena dipakai di View untuk if/else tampilan
    ...
    // [FIX] Mount untuk mendeteksi apakah kita sedang di menu Laporan atau Transaksi
    ...
    public function render()
    {
        ...
        // Judul header menyesuaikan mode
    ...
    // Helper Tampilan Kurung Negatif
