...
class ArIndex extends Component
{
    ...
    public function render()
    {
        ...
        // --- SUMMARY STATS ---
        $summary = [
            'total_piutang' => (clone $query)->sum('nilai'), // Sisa Hutang
            'total_faktur'  => (clone $query)->count(),      // Jumlah Faktur Belum Lunas
            'total_macet'   => (clone $query)->where('umur_piutang', '>', 30)->sum('nilai'), // Total Uang Macet
        ];
