...
class PenjualanIndex extends Component
{
    ...
    {
        // 1. CEK MANUAL: Apakah file sudah ada di properti temporary Livewire?
        // Jika upload di browser (View) belum 100%, properti ini akan NULL/KOSONG.
        if (empty($this->file)) {
