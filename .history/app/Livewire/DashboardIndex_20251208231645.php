...
class DashboardIndex extends Component
{
    ...
    // Properti Public untuk KPI Card (Agar bisa diakses View)
    public $salesSum = 0;
    public $returSum = 0;
    public $arSum = 0;
    public $collSum = 0;
    ...
    public function render()
    {
        ...
        // Rumus: Hapus titik, ganti koma dengan titik (jika format Indo: 1.000.000,00)
    ...
    private function getChartData()
    {
        ...
        // C. TOP RANKING (PENTING: Masukkan Logic Ranking disini agar masuk ke ChartData)
        ...
        $topProduk = $this->queryPenjualan()
            ...
            ->limit(10)
            ->get()
            ->map(fn($i) => ['name' => Str::limit($i->nama_item, 20), 'value' => (int)$i->total_qty]);
        ...
        $topCustomer = $this->queryPenjualan()
            ...
            ->limit(10)
            ->get()
            ->map(fn($i) => ['name' => Str::limit($i->nama_pelanggan, 15), 'value' => (float)$i->total_beli]);
        ...
        $topSupplier = $this->queryPenjualan()
            ...
            ->limit(10)
            ->get()
            ->map(fn($i) => ['name' => Str::limit($i->supplier, 15), 'value' => (float)$i->total_beli]);
    ...
    private function getSalesmanPerformance()
    {
        ...
        // Bersihkan data angka dengan REPLACE
