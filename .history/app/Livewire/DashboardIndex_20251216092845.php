...
class DashboardIndex extends Component
{
    ...
    {
        // Kita hanya perlu me-dispatch event update chart
        // Render ulang otomatis terjadi setelah fungsi ini selesai
        $this->dispatch('update-charts', data: $this->getChartData());
    }

    // Tampilan sementara saat proses loading data awal (Skeleton Loading)
    public function placeholder()
    {
        return <<<'HTML'
        <div class="min-h-screen space-y-6 font-jakarta p-6 animate-pulse">
    ...
    public function render()
    {
        ...
        // Query akan dijalankan hanya setelah placeholder tampil (Lazy Loading)
    ...
    private function getChartData()
    {
        ...
        // Batasi loop agar tidak hang jika rentang tanggal terlalu jauh (misal user salah pilih tahun)
        if ($c->diffInDays($e) > 366) { $e = (clone $c)->addDays(366); }
