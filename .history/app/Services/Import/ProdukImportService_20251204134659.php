        ...
        try {
            ...
            foreach ($rows as $index => $rawRow) {
                try {
                    ...
                    // Pastikan $row adalah array murni index angka
                    // Cast (array) untuk jaga-jaga jika $rawRow objek
                    $row = array_values((array)$rawRow);

                    // --- AMBIL DATA KUNCI DENGAN 'BRUTAL FORCE' ---
                    ...
                    // Commit per 500 baris agar cepat
                    ...
                    $stats['skipped_error']++;
                    Log::error("Skip Baris " . ($index + 1) . ": " . $e->getMessage());
                    continue; 
                }
            }
