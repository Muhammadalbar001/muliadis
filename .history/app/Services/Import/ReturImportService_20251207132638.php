...
class ReturImportService
{
    public function handle(string $filePath)
    {
        ...
        try {
            ...
            $lastNoRetur    = null;
            $lastStatus     = null;
            $lastTgl        = null; // Ini yang sering kosong
            $lastNoInv      = null;
            $lastKodePel    = null;
            $lastNamaPel    = null;
            ...
            foreach ($reader->getRows() as $rawRow) {
                try {
                    ...
                    $kodeItem    = isset($row[7]) ? trim((string)$row[7]) : ''; // Cek Excel Retur (Kolom H / Index 7)
                    ...
                    if ($noReturRaw !== '') {
                        ...
                        $lastTgl        = $this->parseDateRobust($tglStr);
                    ...
                    $batchData[] = [
                        ...
                        'tgl_retur'         => $lastTgl, // Pastikan ini terisi dari Fill Down
    ...
    private function processBatch(array $data)
    {
        ...
        // Gunakan INSERT (Bukan Upsert/Ignore) agar semua data masuk
