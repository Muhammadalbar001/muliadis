                ...
                <table class="text-[10px] text-left border-collapse whitespace-nowrap min-w-max w-full">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-3 py-3 border-r border-slate-200 text-right text-red-600 font-bold">> 30 Days
                            </th>
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        ...
                        <tr class="hover:bg-orange-50/20 transition-colors odd:bg-white even:bg-slate-50/30">
                            ...
                            <td class="px-3 py-2 border-r border-slate-100 truncate max-w-[200px]">{{ $item->alamat }}
                            </td>
                            <td class="px-3 py-2 border-r border-slate-100">{{ $item->phone }}</td>
                            <td class="px-3 py-2 border-r border-slate-100 text-center font-bold">
                                {{ $item->umur_piutang }}</td>
                            <td class="px-3 py-2 border-r border-slate-100 text-[9px] font-mono">{{ $item->unique_id }}
                            </td>
                            <td class="px-3 py-2 border-r border-slate-100 text-right">
